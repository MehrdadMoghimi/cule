# Adapted from CleanRL's cleanrl/ppo_atari_lstm.py
...
from cule_env import done_tensor, frame_stack_observation, grayscale_observation, make_cule_env, step_env, to_tensor
...
def make_env(env_id, idx, capture_video, run_name):
    def thunk():
        ...
        env = frame_stack_observation(env, 1)
        return env
...
if __name__ == "__main__":
    ...
    if args.env_backend == "cule":
        envs = make_cule_env(
            args.env_id, args.num_envs, device, args.seed, args.capture_video, frame_stack=1
        )
